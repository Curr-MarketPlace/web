      ...
      {arrItem.map((items,i) => (
        ...
        className=" flex flex-col items-start rounded-2xl gap-2  p-3 justify-start w-auto h-auto dark:bg-black bg-white">
          ...
          <div className='text-item1 w-full flex justify-between items-center'>
           ...
           <span className='text-[#616161]  text-sm md:text-xs font-medium dark:text-[#D463F9]'>12.2k fav</span>
         </div>
         <div className='text-item2 flex justify-start items-center'>
           <span className='text-[#616161] text-sm md:text-xs] font-medium dark:text-[#D463F9]'>@Joker</span>
         </div>
         <div className='text-item1 w-full flex justify-between items-center'>
           <span className=' text-sm md:text-xs font-medium'>Current bid</span>
